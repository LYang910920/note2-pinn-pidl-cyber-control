...
\begin{document}
\tutorialtitle{Code Running Guide}{How to Run and Extend the Note 2 Python Examples}{Installation, smoke tests, training diagnostics, outputs, and troubleshooting}{Companion to the PINN/PIDL cyber-control guide}
\tableofcontents
\newpage
