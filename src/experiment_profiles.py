...
PROFILES: dict[str, NeuralControlProfile] = {
    ...
    "node-sips-inverse-pinn": NeuralControlProfile(
        ...
        script="src/node_sips_inverse_pinn.py",
        ...
        first_functions_to_edit=("generate_truth", "toy_adjacency", "NodeSIPSStateNet", "train"),
        ...
        hyperparameters=(
            ("smoke command", "python src/node_sips_inverse_pinn.py --smoke --device cpu"),
            ("default nodes/grid", "8 nodes, 2 communities, 61 time points"),
            ("rate model", "positive community-specific susceptibility, infectivity, and gamma; base beta fixed"),
