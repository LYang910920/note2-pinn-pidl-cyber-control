...
\item baseline metrics in \texttt{experiments/baseline\_comparison\_metrics.csv};
\item \texttt{OUTPUT\_PREVIEW.md} and \texttt{training\_summary.md};
\item \texttt{figures/training\_iteration\_diagnostics.png} and \texttt{figures/baseline\_comparison.png}.
\end{itemize}
...
\section{Output Map}
Start with \texttt{experiments/OUTPUT\_PREVIEW.md}. It groups the generated results by experiment, diagnostic panel, baseline-comparison panel, and file. Then inspect \texttt{figures/training\_iteration\_diagnostics.png}, \texttt{figures/baseline\_comparison.png}, and the CSV file for the experiment you are studying.
