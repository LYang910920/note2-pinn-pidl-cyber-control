...
\begin{document}
\lecturetitle{Code Running Guide}{How to Run and Extend the Note 2 Python Examples}{Installation, smoke tests, training diagnostics, outputs, and troubleshooting}{Companion to the PINN/PIDL cyber-control lecture note}
\tableofcontents
\newpage
...
\end{lstlisting}
Expected output: refreshed PNG figures under \texttt{figures/}, including sparse-data setup, PIDL missing-mechanism, and neural-architecture diagrams.
...
Expected output:
\begin{itemize}
\item CSV histories under \texttt{experiments/};
\item \texttt{OUTPUT\_PREVIEW.md} and \texttt{training\_summary.md};
\item \texttt{figures/training\_iteration\_diagnostics.png}.
\end{itemize}
...
\section{Output Map}
Start with \texttt{experiments/OUTPUT\_PREVIEW.md}. It groups the generated results by experiment, diagnostic panel, and file. Then inspect \texttt{figures/training\_iteration\_diagnostics.png} and the CSV file for the experiment you are studying.
